...
<title>360 Evaluation | Create Department</title>
<!-- InstanceEndEditable -->
...
<div ng-controller="createDepartmentController as createDeptCtrl" style="max-width: 750px;">
    ...
    <entry ng-model="entryForm" program-id="es01dp" edit-mode="create">
      <form ng-submit="SubmitData()">
        <fieldset>
          <div class="form-group">
            <label for="inputDeptCode">Department Code</label>
            <input type="text" class="form-control" id="inputDeptCode" name="dept" ng-model="entryForm.DepartmentCode">
          </div>
          <div class="form-group">
            <label for="inputDesc">Description</label>
            <input type="text" class="form-control" id="inputDesc" name="desc" ng-model="entryForm.Description">
          </div>
          <div class="form-group">
...
$query="INSERT INTO SCHOOL VALUES ('$un','$em')";
