...
<title>360 Evaluation | Create Staff Grade</title>
<!-- InstanceEndEditable -->
...
//		console.log(newValue);
		...
		if(fieldName == "StaffGradeCode")
			newObj.StaffGradeCode = newObj.StaffGradeCode.toUpperCase();
	}
...
<h1 class="page-header">Staff Grade Maintenance</h1>
<!-- InstanceEndEditable -->
<!-- site position start --> 
      ...
      <form ng-submit="SubmitData()">
        <fieldset>
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputDeptCode" name="staffcode" ng-model="entryForm.StaffGradeCode">
          </div>
          <div class="form-group">
